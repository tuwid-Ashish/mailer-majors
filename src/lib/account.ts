...
class Account {
    ...
    async createSubscription() {
        console.log('createSubscription', this.token,);
        const webhookUrl = process.env.NODE_ENV === 'development' ? 'https://6860-103-66-206-3.ngrok-free.app/' : process.env.NEXT_PUBLIC_URL
        console.log("the webhookUrl", webhookUrl,process.env.MODE === 'development');
    ...
    async syncEmails() {
        ...
        console.log('the sync response', response);    
