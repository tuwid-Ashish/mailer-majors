...
export async function generateEmail(context: string, prompt: string) {
    console.log("context of the mail", context , prompt)
    const stream = createStreamableValue('');
    console.log("the context is",stream);
    (async () => {
        ...
        console.log("the text steam", textStream);

        for await (const delta of textStream) {
            console.log("the delta is", delta);
            stream.update(delta);
            console.log("the stream value is", stream.value);        
        }
        console.log("the stream value is", stream.value);        
        stream.done();
    })();
